...
<head>
    ...
    <title>ARSEL - Creer et publier un site</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <form name="basicform" id="basicform" action="{{ URL::to('/store_site') }}"
                                        ...
                                        <fieldset>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control validate" id="libelle_site"
                                                        name="libelle_site" placeholder="Libellé du site" required>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Capacité du
                                                        site (MW)</label>
                                                    <input type="number" class="form-control validate" id="capacite_site"
                                                        name="capacite_site" placeholder="Capacité du site" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1"
                                                    rows="3" placeholder="Sasir une description du site" id="desc_site"
                                                    name="desc_site" required></textarea>
                                            </div>
                                        </fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="region_select"
                                                        class="form-control formselect required" id="region_select">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="quartier_site"
                                                        name="quartier_site" placeholder="Saisir le quartier">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select id="inputState" class="form-control" id="type_exp"
                                                        name="type_exp">
                                                        <option value="0">Choisir le type
                                        ...
                                        <fieldset>
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <select id="type_regime" name="type_regime" class="form-control">
                                                    ...
                                                    <div class="img-uploade-row">
                                                        <div class="upload-column">
                                                            <input onchange="doAfterSelectImage(this)" type="file"
                                                                name="image_site" class="screenshot" id="screenshot"
                                                                style="display:none">
                                                            <input type="hidden" name="csrf-token"
                                                                value="{{ csrf_token() }}" />
                                                            <label for="screenshot" class="img-uploaders">
                                                                <img src="../img/alan-walker-460x460.jpg" width="50%"
                                                                    id="post_user_image_" />
                                                            </label>
                                                        </div>
                                                    </div>
