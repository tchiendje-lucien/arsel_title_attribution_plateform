...
$infos_admin = DB::select('select NOM, PRENOM, PHOTO_ADMIN from users where ID_USER =?',
    ...
    <ul class="ml-auto navbar-nav">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 text-gray-600 d-none d-lg-inline small">{{ $infos_admin->NOM }}
                    {{ $infos_admin->PRENOM }}</span>
                <img class="img-profile rounded-circle"
                    src="{{ URL::asset('images_admin/' . $infos_admin->PHOTO_ADMIN) }}">
            </a>
